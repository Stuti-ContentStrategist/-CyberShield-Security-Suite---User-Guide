...
metaLinks:
  alternates:
    - https://app.gitbook.com/s/Xuaz498uadlzVzXcXu1r/installation-and-setup
---
...
Before you begin, ensure your system meets the requirements below.
...
| ----------------------- | ----------------------------------------- |
| **Operating System**    | Windows 10 or higher / macOS 12 or higher |
...
> 💡 **Tip:** For enterprise environments, your IT admin may provide a pre-configured installer.
...
3. Accept the **License Agreement** and choose an installation path.
4. Click **Install**.
5. When installation completes, click **Finish** to launch the application.
...
3. Enter your **Product Key** (provided in your purchase email).
4. Click **Verify**.
...
2. Choose **Protection Mode** — _Standard_ or _Advanced_.
